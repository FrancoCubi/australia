# Solicitud de cotización a laboratorio: Producto 1 "Base nocturna"

Dos versiones: un mensaje corto de primer contacto (WhatsApp o correo breve) y el pedido de cotización completo para enviar como correo o adjunto. Reemplazar los campos entre corchetes.

---

## A. Mensaje corto de primer contacto
...
## B. Pedido de cotización completo

**Asunto:** Solicitud de cotización: suplemento dietario en polvo (sobres monodosis), glicina + magnesio + L-teanina

Estimados,

Mi nombre es [Nombre], fundador de [Marca], una marca de bienestar enfocada exclusivamente en mejorar la calidad del sueño, con venta directa al consumidor a través de nuestra web en Argentina.

Estamos en la etapa de desarrollo de nuestro primer producto y buscamos un laboratorio elaborador con RNE habilitado que pueda formular, producir y acompañarnos en el registro del producto (RNPA) ante ANMAT. A continuación detallo el producto, las especificaciones y la información que necesitamos para evaluar la propuesta.
...
7. Acondicionamiento en estuche de 30 unidades. Indicar si realizan el armado de estuches o solo entregan sobres a granel.
8. Gestión regulatoria: inscripción del producto (RNPA) ante ANMAT o autoridad jurisdiccional, diseño de rótulo conforme al CAA, y Director Técnico. Indicar si el registro queda a nombre del laboratorio o de nuestra empresa y qué documentación necesitan de nuestra parte.

### 4. Volúmenes para cotizar

Por favor cotizar precio unitario por sobre y por estuche de 30 en estos tres escenarios:

- Escenario 1: 1.000 estuches (30.000 sobres).
- Escenario 2: 3.000 estuches (90.000 sobres).
- Escenario 3: 5.000 estuches (150.000 sobres).

Indicar cantidad mínima de producción y si el precio incluye o no los excipientes, el sobre, el estuche y los análisis.

### 5. Preguntas que necesitamos respondidas

Regulatorias:

1. ¿Tienen experiencia registrando suplementos dietarios con L-teanina? ¿Cuál es la dosis máxima diaria de L-teanina admitida hoy por el CAA (art. 1381) o por ANMAT en la práctica? Nos consta que hay al menos un suplemento dietario nacional en el mercado con 200 mg de L-teanina por comprimido y una toma diaria, así que entendemos que nuestra dosis tiene precedente. Les pedimos que nos confirmen el límite formal y la norma que lo fija.
2. **Punto decisivo para nosotros: la glicina.** ¿Confirman que la glicina está en la tabla de aminoácidos permitidos para suplementos dietarios y que 3.000 mg libres, más aprox. 1.500 mg provenientes del quelato (aprox. 4.500 mg totales), quedan dentro del tope diario? ¿Han registrado antes un suplemento dietario con glicina a esta dosis? Si el tope fuera menor, necesitamos saberlo antes que cualquier otra cosa.
3. ¿Cuál es el límite superior de magnesio elemental que hoy admite el art. 1381 para suplementos, y qué leyenda de rotulado corresponde con 250 mg?
4. ¿Cuál es el plazo estimado desde la aprobación de la fórmula hasta la obtención del RNPA?
5. ¿Pueden certificar el producto como "Sin TACC"? ¿Qué implica en costo y plazo?
...
8. Plazo de entrega estimado para la primera producción y para reposiciones.
9. Condiciones de pago.
10. ¿Realizan producciones de prueba a menor escala que la mínima para validar sabor y mercado?

### 6. Confidencialidad

Solicitamos que la fórmula y las especificaciones compartidas sean tratadas de forma confidencial. Podemos firmar un acuerdo de confidencialidad si lo requieren.

Quedo a disposición para una reunión o visita a la planta.
...
## C. Qué evaluar cuando lleguen las respuestas

| Criterio | Señal positiva | Señal de alerta |
|---|---|---|
| L-teanina | Conocen el tope y han registrado productos con 200 mg | Proponen bajar a 25 a 50 mg "porque es lo que se aprueba" sin citar norma |
| Bisglicinato | Ofrecen CoA con 13,5 a 14,5% de Mg, nombran el proveedor | Ofrecen bisglicinato "al 20%" o "buffered" sin aclarar |
| L-teanina calidad | Suntheanine o CoA de pureza quiral | Solo dicen "teanina" o "extracto de té" |
